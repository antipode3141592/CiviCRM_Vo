...
function vo_crm_load_scripts() {


	wp_enqueue_script('jquery');
	// wp_enqueue_script('listjs', 'https://cdnjs.cloudflare.com/ajax/libs/list.js/1.5.0/list.min.js');
	// wp_enqueue_script('listjs_functions', VO_CRM_BASE_DIR, '/listjs_functions.js');
	...
	// wp_enqueue_script('backboneradio', VO_CRM_BASE_DIR.'/includes/js/backboneradiojs.js');
 }
add_action('wp_enqueue_scripts', 'vo_crm_load_scripts');